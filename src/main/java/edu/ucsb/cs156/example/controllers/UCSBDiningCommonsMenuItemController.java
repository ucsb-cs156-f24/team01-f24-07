...
public class UCSBDiningCommonsMenuItemController extends ApiController {
    ...
    /**
     * List all UCSBDiningCommonsMenuItem
     * 
     * @return an iterable of UCSBDiningCommonsMenuItem
     */
    @Operation(summary= "List all ucsb dining items")
     ...
     * Create a new item
     * 
     * @param diningCommonsCode the diningCommonsCode
    ...
    public UCSBDiningCommonsMenuItem postUCSBDiningCommonsMenuItem(
        ...
        DiningCommonsMenuItem.setStation(station);

        UCSBDiningCommonsMenuItem savedUcsbItems = ucsbDiningCommonsMenuItemRepository.save(DiningCommonsMenuItem);
